...
var strictEqual = _require.strictEqual;
var throws = _require.throws;

describe('react-flipcard', function () {
  it('should throw an error if less than 2 children are provided', function () {
    throws(function () {
      TestUtils.renderIntoDocument(React.createElement(FlipCard, null));
    }, TypeError);
  });

  it('should flip vertically', function () {
    var card = TestUtils.renderIntoDocument(React.createElement(
      FlipCard,
      { type: 'vertical' },
      React.createElement(
        'div',
