...
var _helpersClassSet = require('../helpers/classSet');

var _helpersClassSet2 = _interopRequireDefault(_helpersClassSet);
...
exports['default'] = _react2['default'].createClass({
  ...
  componentDidUpdate: function componentDidUpdate() {
    ...
    if (!this.props.flipped && this.focusElement && (0, _helpersContains2['default'])(this.getDOMNode(), document.activeElement)) {
  ...
  render: function render() {
    return _react2['default'].createElement(
      'div',
      {
        className: (0, _helpersClassSet2['default'])({
          'ReactFlipCard': true,
